...
function loft_polylang_languages($class = '') {
	...
	$languages_without_current = pll_the_languages(array(
		'display_names_as'       => 'slug',
		'hide_if_no_translation' => 1,
		'raw'                    => true,
		'show_flags' => 1,
	...
	<?php if (!empty($languages)): ?>
		<div class="header__lang lang">
			...
			<div class="lang__dropdown">
				<?php foreach($languages_without_current as $language): ?>
					<a href="<?php echo $language['url']; ?>" class="lang__link">
						<span class="lang__flag-wrap">
							<?php echo $language['flag']; ?>
						</span>
